...
export const metadata = {
	title: "Privacy Policy | LinkedCart",
	description:
		"LinkedCart's Privacy Policy - Learn how we collect, use, and protect your personal information.",
};

export default function PrivacyPolicyPage() {
	return (
		<PolicyLayout title="Privacy Policy" lastUpdated="May 15, 2025">
			<section className="space-y-6">
				<h2 className="text-2xl font-semibold">Introduction</h2>
				<p>
					At LinkedCart, we respect your privacy and are committed to protecting
				...
				<p>
					This privacy policy aims to give you information on how LinkedCart
					...
					you sign up for our waitlist, use our services, or participate in a
					survey.
				</p>
			</section>
			...
			<section className="space-y-6">
				...
				<ul className="list-disc pl-6 space-y-2">
					<li>
						<span className="font-medium">Identity Data</span> includes first
						name, last name, username or similar identifier.
					</li>
					<li>
						<span className="font-medium">Contact Data</span> includes billing
					...
					<li>
						<span className="font-medium">Usage Data</span> includes information
			...
			<section className="space-y-6">
				...
				<p>
					...
					practices, please contact us at: privacy@linkedcart.com
				</p>
			</section>
		</PolicyLayout>
	);
